...
if [ ! -f "$ARQUIVO_PUBLICO" ]; then
    echo "[ex03] FAIL: Arquivo 'id_rsa_pub' not found em ex03/" 
    exit $FAIL
fi

# ==============================================================================
# BLOCK: VALIDAÇÃO DE INTEGRIDADE (FORMATO SSH)
...
# ==============================================================================
# BLOCK: CHECK DE SEGURANÇA (IDENTIFICAÇÃO)
